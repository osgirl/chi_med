                ...
                <div role="tabpanel" class="tab-pane fade in active" id="main">
                  <table class="table table-hover table-bordered table-condense">
                    <tr class="warning">
                      ...
                      <td>Date</td>
                      <td>
                        <input class="datepicker form-control" name="date" size="16" type="text" value="{{ date('d-m-Y', strtotime($record->date))}}" required>
                      </td>
                    </tr>
                    <tr>
                      <th class="warning">Injury Date</th>
                      <td colspan="5">
                        <input class="datepicker form-control" name="injury_date" size="16" type="text" placeholder="dd-mm-yyyy" value="{{ date('d-m-Y', strtotime($record->injury_date))}}" required>
                      </td>
                    </tr>
                    <tr>
