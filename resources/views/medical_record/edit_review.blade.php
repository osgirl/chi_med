...
<div class="">
    <div class="row">
      ...
      <div class="well well-sm col-sm-12">
        <div class="col-sm-3">
          <a href="{{ url('/patient/'.$patient->patient_id)}}" class="btn btn-warning btn-block">
        ...
        <div class="col-sm-10 col-sm-offset-1">
          ...
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade in active" id="review">
              <form class="form" action="{{ url('/medical_review/'.$patient->id)}}" method="post" role="form">
                {!! csrf_field() !!}
                ...
                <div class="form-group">
                  <table class="table table-hover table-bordered table-condense">
                    ...
                    <tr>
                      ...
                      <td class="col-sm-9" colspan="5"><textarea class="form-control" rows="5" name="summary">{{ $records->summary}}</textarea></td>
                    </tr>
                    <tr>
                      <th class="warning">Investigation</th>
                      <td colspan="5"><textarea class="form-control" rows="5" name="investigation">{{ $records->investigation}}</textarea></td>
                    </tr>
                    <tr>
                      <th class="warning">Outcomes</th>
                      <td colspan="5"><textarea class="form-control" rows="5" name="outcomes">{{ $records->outcomes}}</textarea></td>
                    </tr>
                    <tr>
                      <th class="warning">Differential Diagnosis</th>
                      <td colspan="5"><textarea class="form-control" rows="5" name="differential_diagnosis">{{ $records->differential_diagnosis}}</textarea></td>
                    </tr>
                    <tr>
                      <th class="warning">Treatment</th>
                      <td colspan="5"><textarea class="form-control" rows="5" name="treatment">{{ $records->treatment}}</textarea></td>
                    </tr>
                    <tr>
                      <th class="warning">Discussion</th>
                      <td colspan="5"><textarea class="form-control" rows="5" name="discussion">{{ $records->discussion}}</textarea></td>
                    </tr>
                  </table>
