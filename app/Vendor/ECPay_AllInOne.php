...
class ECPay_Send extends ECPay_Aio
{
    ...
    {
        //宣告付款方式物件
        $PaymentMethod  = 'App\Vendor\ECPay_'.$arParameters['ChoosePayment'];
...
class ECPay_CheckMacValue{
    ...
    static function generate($arParameters = array(),$HashKey = '' ,$HashIV = '',$encType = 0){
        ...
        if(isset($arParameters))
        {
            ...
            uksort($arParameters, array('App\Vendor\ECPay_CheckMacValue','merchantSort'));
